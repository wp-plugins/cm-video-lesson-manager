...
namespace com\cminds\videolessons;

use com\cminds\videolessons\shortcode\BookmarksShortcode;
...
class App {
	...
	const BASE_NAMESPACE = 'com\cminds\videolessons';
	...
	static function bootstrap() {
		...
		// Licensing API
		if (self::isPro()) {
			self::$licensingApi = new \CMVL_Cminds_Licensing_API('CM Video Lessons Pro', App::MENU_SLUG, 'CM Video Lessons Pro', CMVL_PLUGIN_FILE,
				array('release-notes' => 'http://videolessons.cminds.com/release-notes/'), '', array('CM Video Lessons Pro'));
		}
	...
	static function admin_menu() {
		$page = add_menu_page('Video Lessons', 'Video Lessons', 'manage_options', App::MENU_SLUG, create_function('$q', 'return;'), 'dashicons-video-alt2');
	}
