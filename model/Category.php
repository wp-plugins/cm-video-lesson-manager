...
class Category extends TaxonomyTerm {
	...
	static function init() {
		...
		$args = array(
			...
			'public'                => true,
			'rewrite' => array('slug' => Settings::getOption(Settings::OPTION_PERMALINK_PREFIX)),
        );
	 ...
	 * @return com\cminds\videolessons\model\Category
	 */
	...
	/**
	 * 
	 * @return com\cminds\videolessons\model\Channel
	 */
