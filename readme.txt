...
> #### Pro Version
>
> In the Pro version we have added several methods to support Payments, Student Tracking and personal notes ad 
> bookmarks. Admins can lock any channel to be viewed only after a payment has been made. Payment is done by
> using CM MicroPayment and Easy Digital Downloads. It is possible to set a defined number of days in which he
...
> * Shows Progress Report per user and channels viewed
